...
void console_clear(ConsoleRenderer* console, wchar_t ch, ATTR attr) {
...
void _console_put(ConsoleRenderer* console, int x, int y, wchar_t ch, ATTR attr) {
    int idx = y * WIDTH + x;
    console->backBuffer[idx].ch   = ch;
    console->backBuffer[idx].attr = attr;
}

void console_put(ConsoleRenderer* console, int x, int y, wchar_t ch, ATTR attr) {
